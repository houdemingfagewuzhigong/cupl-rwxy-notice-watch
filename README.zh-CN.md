...
这是一个非官方的中国政法大学人文学院公开通知公告归档项目。它每天抓取学院网站的“通知公告”和“学院动态”栏目，保存历史数据，并生成一个可以直接打开的静态公告看板。

![看板截图](assets/frontend-desktop.png)

## 项目用途

人文学院的党建公示、研究生培养、学术活动、奖项公告和学院新闻具有明显时效性。本项目把公开网页中的公告整理成结构化数据，方便检索、导出、归档和后续做跨学院聚合。

## 目标站点

- 站点：中国政法大学人文学院
- 官方主页：https://rwxy.cupl.edu.cn/
- 通知公告：https://rwxy.cupl.edu.cn/index/tzgg.htm
- 学院动态：https://rwxy.cupl.edu.cn/index/xydt.htm
...
本项目只抓取公开网页信息，不绕过访问控制，不抓取个人隐私数据，不代表中国政法大学或人文学院官方。涉及培养、学位、课程和活动等事项时，请以学院官方网站发布内容为准。
